...
redis-cli -a komatkhau2 --cluster create $node_1_ip:6379 $node_2_ip:6379 $node_3_ip:6379 $node_4_ip:6379 $node_5_ip:6379 $node_6_ip:6379 --cluster-replicas 1 --cluster-yes